          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 items-center">
                {(() => {
                  const description = t("about.interests.description");
                    ...
                    return (
                      <>
                        ...
                        <a
                          ...
                          className="inline-flex items-center ml-1.5 text-purple-600 hover:text-purple-700 transition-colors cursor-pointer"
